...
;;; Last modified: Fri Nov 20 00:10:00 CET 2009
...
(eval-after-load "meta-mode"
  '(progn
     (pi-tempo-add
      ...
      'tempo-meta-table    ;; Table name (* MUST BE UNIQUE *).
      'tempo-meta-tagslist ;; Name of the variable where the tag list should be added.
      '(
        ("pre"  ("prologues:=2;
verbatimtex
%&latex
