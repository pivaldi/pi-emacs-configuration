...
FUNC_SKEL = """#contributor : Andrew Gwozdziewycz <web@apgwoz.com> & Philippe Ivaldi <www.piprime.fr>
...
if sys.argv[1] == '-f':
    ...
    print 'You must give the php file to process.'
    sys.exit(1)
...
if __name__ == "__main__":
    defs = parse_definitions(php_file)
